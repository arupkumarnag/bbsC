...
class KetchupPage extends StatefulWidget {
  @override
  _KetchupPageState createState() => _KetchupPageState();
}

class _KetchupPageState extends State<KetchupPage> {
  int total = 0;
  ...
  void initState() {
    ...
    service.getKetchupMayo(orderNotifier);   ///From Notifier from App Screen
    ...
    return Container(
      child: Scaffold(
        ...
        body: StreamBuilder<List<ProductModel>>(
            stream: productBloc.fetchAvailableKetchups,
