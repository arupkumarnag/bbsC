...
class _RicePageState extends State<RicePage> {
  ...
  void initState() {
    ...
    service.getRicePulses(orderNotifier);   ///From Notifier from App Screen
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Center(
              child: Text('Rice & Pulses', style: GoogleFonts.poppins(
        ...
        body: StreamBuilder<List<ProductModel>>(
            stream: productBloc.fetchAvailableRice,
