...
class _SpicesPageState extends State<SpicesPage> {
  ...
  void initState() {
    ...
    service.getSpicesSalt(orderNotifier);   ///From Notifier from App Screen
  ...
  Widget build(BuildContext context) {
    ...
    final firestoreService = Provider.of<ProductService>(context);
    ...
    return Container(
      child: Scaffold(
        ...
        body: StreamBuilder<List<ProductModel>>(
            stream: productBloc.fetchAvailableSpice,
