...
class NoodlePage extends StatefulWidget {
  @override
  _NoodlePageState createState() => _NoodlePageState();
}
...
class _NoodlePageState extends State<NoodlePage> {
  ...
  void initState() {
    ...
    service.getNoodlesSnacks(orderNotifier);

    ///From Notifier from App Screen
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        child: Scaffold(
        appBar: AppBar(
        title: Center(child: Text('Noodles & Snacks',
      ...
      Stack(children: <Widget>[
          ...
          body: StreamBuilder<List<ProductModel>>(
              stream: productBloc.fetchAvailableNoodle,
